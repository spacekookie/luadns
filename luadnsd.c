...
int get_A_Record(uchar addr[4], const char domain_name[],struct sockaddr_in* client_addr)
{
...
int get_AAAA_Record(uchar addr[16], const char domain_name[],struct sockaddr_in* client_addr)
{
